class Book < ActiveRecord::Base
  ...
  enum :availability, {
    "Κυκλοφορεί": 0, "Υπό Έκδοση": 1, "Εξαντλημένο": 2,
    "Κυκλοφορεί - Εκκρεμής εγγραφή": 3, "Έχει αποσυρθεί από την κυκλοφορία": 4
  }
  enum :cover_type, { "Μαλακό εξώφυλλο": 0, "Σκληρό εξώφυλλο": 1, Spiral: 2 }
  enum :format, {
    "Βιβλίο": 0, "CD-ROM": 1, "CD-Audio": 2, "Κασέτα": 3, "Χάρτης": 4,
    "Επιτραπέζιο παιχνίδι": 5, "Κασέτα VHS": 6, "Παιχνίδια-Κατασκευές": 7,
    "DVD-ROM": 8, "Video DVD": 9, "Video CD": 10, "e-book": 11, "Άλλο": 12
  }
