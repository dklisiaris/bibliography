var App = function() {
  var e, a, i, s, t, l, o, r, n, d = function() {
      ...
      var d = $("#year-copy"),
        h = new Date;
      d.html(2014 === h.getFullYear() ? "2014" : "2014-" + h.getFullYear().toString().substr(2, 2)), b($(".btn-effect-ripple"), "btn-ripple"), $('[data-toggle="tabs"] a, .enable-tabs a').click(function(e) {
    ...
    c = function() {
      ...
      a.on("click", function(e) {
        var a, i, t, l, o = $(this);
        s.find(".sidebar-nav-ripple").removeClass("animate"), 0 == o.children(".sidebar-nav-ripple").length && o.prepend('<span class="sidebar-nav-ripple"></span>');
        var a = o.children(".sidebar-nav-ripple");
        a.height() || a.width() || (i = Math.max(o.outerWidth(), o.outerHeight()), a.css({
          height: i,
          width: i
        })), t = e.pageX - o.offset().left - a.width() / 2, l = e.pageY - o.offset().top - a.height() / 2, a.css({
          top: l + "px",
          left: t + "px"
        }).addClass("animate")
      }), i.on("click", function() {
        ...
        return e.hasClass("sidebar-visible-lg-mini") && i > 991 ? a.hasClass("open") ? a.removeClass("open") : ($("#sidebar .sidebar-nav-menu.open").removeClass("open"), a.addClass("open")) : a.parent().hasClass("active") || (a.hasClass("open") ? a.removeClass("open") : ($("#sidebar .sidebar-nav-menu.open").removeClass("open"), a.addClass("open")), setTimeout(g, 50)), !1
      }), t.on("click", function() {
        var e = $(this);
        return e.parent().hasClass("active") !== !0 && (e.hasClass("open") ? e.removeClass("open") : (e.closest("ul").find(".sidebar-nav-submenu.open").removeClass("open"), e.addClass("open")), setTimeout(g, 50)), !1
      })
    },
    b = function(e, a) {
      e.css({
        ...
        i.height() || i.width() || (s = Math.max(o.outerWidth(), o.outerHeight()), i.css({
          height: s,
          width: s
        })), t = e.pageX - o.offset().left - i.width() / 2, l = e.pageY - o.offset().top - i.height() / 2, i.css({
          top: l + "px",
          left: t + "px"
        }).addClass("animate")
      })
    ...
    p = function(a) {
      if ("init" === a) {
        p("sidebar-scroll"), p("sidebar-alt-scroll");
        var s;
        $(window).on("resize orientationchange", function() {
        ...
        if ("toggle-sidebar" === a) d > 991 ? (e.hasClass("sidebar-visible-lg-full") ? e.removeClass("sidebar-visible-lg-full").addClass("sidebar-visible-lg-mini") : e.hasClass("sidebar-visible-lg-mini") ? e.removeClass("sidebar-visible-lg-mini").addClass("sidebar-visible-lg-full") : e.addClass("sidebar-visible-lg-mini"), setTimeout(g, 50)) : (e.toggleClass("sidebar-visible-xs"), e.hasClass("sidebar-visible-xs") && p("close-sidebar-alt")), p("sidebar-scroll");
        else if ("open-sidebar" === a) d > 991 ? e.removeClass("sidebar-visible-lg-mini").addClass("sidebar-visible-lg-full") : (e.addClass("sidebar-visible-xs"), p("close-sidebar-alt")), p("sidebar-scroll"), setTimeout(g, 50);
        else if ("close-sidebar" === a) d > 991 ? e.removeClass("sidebar-visible-lg-full").addClass("sidebar-visible-lg-mini") : e.removeClass("sidebar-visible-xs"), p("sidebar-scroll");
          ...
          if (e.hasClass("sidebar-visible-lg-mini") && d > 991) r.length && r.parent(".slimScrollDiv").length && (r.slimScroll({
            ...
            992 > d && (h -= 50), r.length && !r.parent(".slimScrollDiv").length ? r.slimScroll({
              height: h,
              color: "#bbbbbb",
              size: "3px",
              touchScrollStep: 100,
    ...
    m = function() {
      ...
      h && (a = $.cookie("optionThemeColor") ? $.cookie("optionThemeColor") : !1, s = $.cookie("optionThemeHeader") ? $.cookie("optionThemeHeader") : !1, t = $.cookie("optionThemeSidebar") ? $.cookie("optionThemeSidebar") : !1, s ? i.removeClass("navbar-inverse navbar-default").addClass(s) : !1, t ? e.removeClass("sidebar-light").addClass(t) : !1, a && ("default" === a ? o.length && (o.remove(), o = $("#theme-link")) : o.length ? o.attr("href", a) : ($('link[href="css/themes-2.1.css"]').before('<link id="theme-link" rel="stylesheet" href="' + a + '">'), o = $("#theme-link"))), r = a ? a : r, n = s ? s : n, d = t ? t : d), $('a[data-theme="' + r + '"][data-theme-navbar="' + n + '"][data-theme-sidebar="' + d + '"]', l).parent("li").addClass("active"), $("a", l).click(function() {
        r = $(this).data("theme"), n = $(this).data("theme-navbar"), d = $(this).data("theme-sidebar"), $("li", l).removeClass("active"), $(this).parent("li").addClass("active"), i.removeClass("navbar-inverse navbar-default").addClass(n), e.removeClass("sidebar-light").addClass(d), "default" === r ? o.length && (o.remove(), o = $("#theme-link")) : o.length ? o.attr("href", r) : ($('link[href="css/themes-2.1.css"]').before('<link id="theme-link" rel="stylesheet" href="' + r + '">'), o = $("#theme-link")), h && ($.cookie("optionThemeColor", r, {
          expires: 7
