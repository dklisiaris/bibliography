Rails.application.configure do
  ...
  config.assets.compile = false # Should be false in production, but assets arent loading. Needs further investigation.
  ...
  config.active_job.queue_name_prefix = "bibliography_#{Rails.env}"
